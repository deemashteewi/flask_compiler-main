...
public class pythonParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class TruthyConditionContext extends ConditionContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TruthyConditionContext(ConditionContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof pythonParserListener ) ((pythonParserListener)listener).enterTruthyCondition(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof pythonParserListener ) ((pythonParserListener)listener).exitTruthyCondition(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof pythonParserVisitor ) return ((pythonParserVisitor<? extends T>)visitor).visitTruthyCondition(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ConditionContext condition(int _p) throws RecognitionException {
		...
		try {
			...
			case 6:
				{
				_localctx = new TruthyConditionContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(200);
				expr();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(205);
						((AndConditionContext)_localctx).right = condition(9);
						}
						break;
					case 2:
						{
						...
						setState(208);
						((OrConditionContext)_localctx).right = condition(8);
						}
						break;
					}
					} 
