...
public interface pythonParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code TruthyCondition}
	 * labeled alternative in {@link pythonParser#condition}.
	 * @param ctx the parse tree
	 */
	void enterTruthyCondition(pythonParser.TruthyConditionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code TruthyCondition}
	 * labeled alternative in {@link pythonParser#condition}.
	 * @param ctx the parse tree
	 */
	void exitTruthyCondition(pythonParser.TruthyConditionContext ctx);
	/**
